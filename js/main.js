...
(function($) {
    ...
    var cfg = {
        ...
        mailChimpURL   : 'https://tamu.us17.list-manage.com/subscribe/post?u=7f75f183f267a7e5fb928df01&amp;id=9a2db55a7f'   // mailchimp url
    },
    ...
    * ------------------------------------------------------ */
    var ssAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Submitting...',
            0: '<i class="fas fa-check"></i> Thank you for signing up!',
